...
namespace CarMNS.Utilities.Constants
{
    public class CommonConstants
    {
        ...
        // VP thứ 7 tính như SX
        public static string[] arrSatuday_VP_AbNormal =
        {
            "2023-06-17",
            "2023-06-10"
        };
        ...
        public static string ROLE_DANGKY = "BOPHAN_DANGKY";
        public static string ROLE_GROUP_LD = "BO_PHAN_DUYET";
        public static string ROLE_HR = "NHAN_SU_DUYET";
        public static string ROLE_HR_TOP = "QUANLY_SUPPORT_DUYET";
    }
}
