var WLP2_Thickness200_ChartControl = function () {
    const legenMargin = {
        id: 'legendMargin',
    ...
    this.DrawChart = function () {
        ...
        for (d of chartData_200) {
            dataLabel.push(d.LOT_ID);
        }

        let ctx6 = document.getElementById('chartsLine_control_200').getContext('2d');
        ...
        var resultData = AvggroupBy(chartData_200, function (item) {
        ...
        var ctx1 = document.getElementById('chartsColumn_control_200').getContext('2d');
        ...
        $('#btnNext_200').on('click', function () {
            ...
            $('#txtItems_200').text("Items: " + ControlChart.config.options.scales.x.max + "/" + dataLenght);
            ControlChart.update();
        });

        $('#btnPre_200').on('click', function () {
            ...
            console.log(ControlChart.config.options.scales.x.min, ControlChart.config.options.scales.x.max);
            const dataLenght = ControlChart.data.labels.length;
            $('#txtItems_200').text("Items: " + ControlChart.config.options.scales.x.min + "/" + dataLenght);
            ControlChart.update();
        });
