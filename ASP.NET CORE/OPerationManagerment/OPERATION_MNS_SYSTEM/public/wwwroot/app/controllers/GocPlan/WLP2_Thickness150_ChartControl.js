var WLP2_Thickness150_ChartControl = function () {
    const legenMargin = {
        id: 'legendMargin',
    ...
    this.DrawChart = function () {
        ...
        for (d of chartData_150) {
            dataLabel.push(d.LOT_ID);
        }

        let ctx6 = document.getElementById('chartsLine_control_150').getContext('2d');
        ...
        var resultData = AvggroupBy(chartData_150, function (item) {
        ...
        var ctx1 = document.getElementById('chartsColumn_control_150').getContext('2d');
        ...
        $('#btnNext_150').on('click', function () {
            ...
            $('#txtItems_150').text("Items: " + ControlChart.config.options.scales.x.max + "/" + dataLenght);
            ControlChart.update();
        });

        $('#btnPre_150').on('click', function () {
            ...
            console.log(ControlChart.config.options.scales.x.min, ControlChart.config.options.scales.x.max);
            const dataLenght = ControlChart.data.labels.length;
            $('#txtItems_150').text("Items: " + ControlChart.config.options.scales.x.min + "/" + dataLenght);
            ControlChart.update();
        });
