...
{
    public partial class addNewStayLotwlp2 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "STAY_LOT_LIST_HISTORY_WLP2",
                columns: table => new
                {
                    ...
                    LotCategory = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_STAY_LOT_LIST_HISTORY_WLP2", x => new { x.LotId, x.History_seq });
                });

            migrationBuilder.CreateTable(
                name: "STAY_LOT_LIST_WLP2",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_STAY_LOT_LIST_WLP2", x => x.Id);
                });
        }
