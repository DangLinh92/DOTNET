...
{
    public class EFRepository<T, K> : IRespository<T, K>, IDisposable where T : DomainEntity<K>
    {
        ...
        public ResultDB ExecProceduce3(string ProcName, Dictionary<string, string> Dictionary,string connString)
        {
            try
            {
