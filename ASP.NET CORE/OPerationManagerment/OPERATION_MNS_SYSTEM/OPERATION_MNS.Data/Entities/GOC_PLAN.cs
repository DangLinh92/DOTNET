...
{
    [Table("GOC_PLAN")]
    public class GOC_PLAN : DomainEntity<int>, IDateTracking
    {
        public GOC_PLAN()
        {
        ...
        public GOC_PLAN(int id,string module,string model,string material,string division,float standarQty,string monthPlan,string datePlan,float qtyPlan,
