...
{
    [Table("STAY_LOT_LIST_SAMPLE")]
    public class STAY_LOT_LIST_SAMPLE : DomainEntity<int>, IDateTracking
    {
        public STAY_LOT_LIST_SAMPLE()
        {

        }

        public STAY_LOT_LIST_SAMPLE(string lotId, string phuongAnXuLy,string tenLoi,string nguoixuly,string cassettleId,double seq,string phanloaiLoi)
        {
            LotId = lotId;
