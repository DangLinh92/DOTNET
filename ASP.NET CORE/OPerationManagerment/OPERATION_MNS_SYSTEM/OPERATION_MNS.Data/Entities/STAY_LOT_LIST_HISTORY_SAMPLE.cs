...
{
    [Table("STAY_LOT_LIST_HISTORY_SAMPLE")]
    public class STAY_LOT_LIST_HISTORY_SAMPLE : IDateTracking
    {
        public STAY_LOT_LIST_HISTORY_SAMPLE()
        {
        ...
        [StringLength(50)]
        public string HoldUserCode { get; set; }
