...
namespace HRMS.Areas.Payroll.Controllers
{
    public class AccountController : AdminBaseController
    {
        ...
        public AccountController(IWebHostEnvironment hostingEnvironment, UserManager<APP_USER> userManager, SignInManager<APP_USER> signInManager, IEmailSender emailSender, ILogger<AccountController> logger, IHttpContextAccessor httpContextAccessor, IMemoryCache memoryCache)
        {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new APP_USER
                {
                    ...
                    EmailConfirmed = true // The Two-Factor Authentication for a user also needs the EmailConfirmed column value to be true
                };
        ...
        public async Task<IActionResult> ExternalLoginConfirmation(ExternalLoginViewModel model, string returnUrl = null)
        {
            if (ModelState.IsValid)
            {
                ...
                var user = new APP_USER { UserName = model.Email, Email = model.Email };
        ...
        public async Task<IActionResult> ResetPassword(ResetPasswordViewModel model)
        {
            ...
            if (result.Succeeded)
            {
                var updateUser = await _userManager.FindByNameAsync(model.Username);
                updateUser.ShowPass = model.Password;
