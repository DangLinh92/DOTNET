...
{
    public class SamsungTrainingController : AdminBaseController
    {
        private ITrainingTypeService _trainingTypeService;
        private readonly IWebHostEnvironment _hostingEnvironment;

        public SamsungTrainingController(ITrainingTypeService trainingTypeService, IWebHostEnvironment hostingEnvironment)
        {
