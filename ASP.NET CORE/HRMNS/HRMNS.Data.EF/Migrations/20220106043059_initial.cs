        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiaChiThuongTru = table.Column<string>(nullable: true),
                    ...
                    NoiCapCMTND = table.Column<string>(nullable: true),
                    ...
                    DChiHienTai = table.Column<string>(nullable: true),
                    KyLuatLD = table.Column<string>(maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MaNV = table.Column<string>(maxLength: 50, nullable: true),
                    SoYeuLyLich = table.Column<string>(maxLength: 50, nullable: true),
                    CMTND = table.Column<string>(maxLength: 50, nullable: true),
                    SoHoKhau = table.Column<string>(maxLength: 50, nullable: true),
                    GiayKhaiSinh = table.Column<string>(maxLength: 50, nullable: true),
                    BangTotNghiep = table.Column<string>(maxLength: 50, nullable: true),
                    XacNhanDanSu = table.Column<string>(maxLength: 50, nullable: true),
                    AnhThe = table.Column<string>(maxLength: 50, nullable: true),
                    DateCreated = table.Column<string>(maxLength: 50, nullable: true),
                    DateModified = table.Column<string>(maxLength: 50, nullable: true),
                    UserCreated = table.Column<string>(maxLength: 50, nullable: true),
                    UserModified = table.Column<string>(maxLength: 50, nullable: true),
