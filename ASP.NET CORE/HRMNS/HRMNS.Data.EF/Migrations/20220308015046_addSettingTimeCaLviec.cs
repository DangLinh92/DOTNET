...
{
    public partial class addSettingTimeCaLviec : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NgayBatDauDangKy = table.Column<string>(maxLength: 50, nullable: true),
                    NgayKetThucDangKy = table.Column<string>(maxLength: 50, nullable: true),
