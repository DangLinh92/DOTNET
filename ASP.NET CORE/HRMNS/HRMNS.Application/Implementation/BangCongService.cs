...
namespace HRMNS.Application.Implementation
{
    public class BangCongService : BaseService, IBangCongService
    {
                        ...
                        tasks[boIndex] = Task.Run(() =>
                        {
                            ...
                            for (int i = 1; i <= DateTime.Parse(endMonth).Day; i++) // day 1 -> 31 or end month
                            {
                                ...
                                foreach (var item in chamCongDataViewModels)
                                {
                                    ...
                                    if (item.MaNV == "H1911025" && dateCheck == "2024-09-01")
                                    {
                                        var x = 0;
                                    }
                                    ...
                                    if (hopDong_NV != null)
                                    {
                                        if (hopDong_NV.ShortName.NullString() == CommonConstants.HD_THUVIEC_EM) // HD Thu viec 85% luong
                                        {
                                            ...
                                            if (_caLamViec != null)
                                            {
                                                ...
                                                {
                                                    if (kyhieuChamCongDB == "IL")
                                                    {
                                                        item.WorkingStatuses.Add(new WorkingStatus()
                                                        {
                                                            DayCheck = dateCheck,
                                                            Value = kyhieuChamCongDB.NullString(),
                                                            FromTime = "00:00:00",
                                                            ToTime = "00:00:00",
                                                        });
                                                    }
                                                    else
                                                    if (CheckNgayDB(dateCheck, _caLamViec.MaCaLaviec, false) == 1)
                                                    {
                                                        item.WorkingStatuses.Add(new WorkingStatus()
                                                        {
                                                            DayCheck = dateCheck,
                                                ...
                                                if (_caLamViec.MaCaLaviec == CommonConstants.CA_DEM && firstTime != "00:00:00")
                                                {
                                                    ...
                                                    if (dateCheck == "2024-02-08" && string.Compare(firstTime, "15:00:00") < 0)
                                                    {
                                                        firstTime = "15:00:00";
                                                    }
                                                ...
                                                if (_chamCongLog.FirstIn.NullString() == CommonConstants.IN && _chamCongLog.LastOut.NullString() == CommonConstants.OUT && Math.Abs(TimeSpan.Parse(lastTime).Subtract(TimeSpan.Parse(firstTime)).TotalHours) >= 0.2)
                                                {
                                                    ...
                                                    if (_caLamViec.MaCaLaviec == CommonConstants.CA_NGAY)
                                                    {
                                                        ...
                                                        if (dateCheck == "2024-02-08" && item.lstNhanVienCaLamViec.Any(x => string.Compare(x.BatDau_TheoCa, dateCheck) <= 0 && string.Compare(x.KetThuc_TheoCa, dateCheck) >= 0))
                                                        {
                                                            ...
                                                            if (string.Compare(lastTime, "15:00:00") > 0)
                                                            {
                                                                lastTime = "15:00:00";
                                                            }
                                                        }
                                                        ...
                                                        {
                                                            if (DateTime.ParseExact(firstTime, "HH:mm:ss", CultureInfo.InvariantCulture) <= DateTime.ParseExact("08:10:00", "HH:mm:ss", CultureInfo.InvariantCulture))
                                                            {
                                                                firstTime = beginTimeCaNgay;
                                                            }
                                                        }

                                                        if (CheckNgayDB(dateCheck, CommonConstants.CA_NGAY, true) == 0) // ngay thuong
                                                        {
                                                            isSetMaxOT = true;
                                                            ...
                                                            if ((item.BoPhan == CommonConstants.SUPPORT_DEPT || HR_NHANVIEN_CHEDO_DBs.Exists(x => x.MaNhanVien == item.MaNV && x.CheDoDB.Contains("vp_Block_10p"))) && DateTime.Parse(dateCheck).DayOfWeek == DayOfWeek.Saturday
                                                                && !CommonConstants.arrSatuday_VP_AbNormal.Contains(dateCheck))
                                                            {
                                                                newBeginOT = GetTimeCaLamViec(item.BoPhan, _caLamViec.MaCaLaviec, dateCheck, item.VP_SX).BeginTimeOT;//"17:30:00";
                                                        ...
                                                        else if (CheckNgayDB(dateCheck, CommonConstants.CA_NGAY, true) == 5 || CheckNgayDB(dateCheck, CommonConstants.CA_NGAY, true) == 7) // Ngay ki niem cty
                                                        {
                                                            ...
                                                            double timeOT = 0;
                                                            timeOT = (DateTime.ParseExact(dateCheck + " " + lastTime, "yyyy-MM-dd HH:mm:ss", CultureInfo.InvariantCulture) - DateTime.ParseExact(dateCheck + " 17:30:00", "yyyy-MM-dd HH:mm:ss", CultureInfo.InvariantCulture)).TotalHours;
                                                        ...
                                                        else if (CheckNgayDB(dateCheck, CommonConstants.CA_NGAY, true) == 3 || CheckNgayDB(dateCheck, CommonConstants.CA_NGAY, true) == 4) // ngay chu nhat or nghi bu ngay le
                                                        {
                                                            var clviec = item.lstNhanVienCaLamViec.FirstOrDefault(x =>
                                                                 string.Compare(dateCheck, x.BatDau_TheoCa) >= 0 &&
                                                                 string.Compare(dateCheck, x.KetThuc_TheoCa) <= 0 &&
                                                            ...
                                                            if (timeOT > 4)
                                                            {
                                                                timeOT = timeOT >= 9.5 ? timeOT - 1.5 : (timeOT >= 9 ? 8 : (timeOT >= 5 ? timeOT - 1 : 4));
                                                            }
                                                            ...
                                                            ChamCongDB _congDB = item.lstChamCongDB.OrderByDescending(x => x.DateModified).FirstOrDefault(x => string.Compare(dateCheck, x.NgayBatDau) >= 0 && string.Compare(dateCheck, x.NgayKetThuc) <= 0 && (x.KyHieuChamCong == "EL" || x.KyHieuChamCong == "LC"));
                                                            if (_congDB != null && _congDB.GiaTri > 0 && CheckNgayDB(dateCheck, CommonConstants.CA_NGAY, true) == 3)
                                                            {
                                                                timeOT -= _congDB.GiaTri;
                                                            }
                                                        ...
                                                        else if (CheckNgayDB(dateCheck, CommonConstants.CA_NGAY, true) == 1) // ngay le
                                                        {
                                                            var clviec = item.lstNhanVienCaLamViec.FirstOrDefault(x =>
                                                                string.Compare(dateCheck, x.BatDau_TheoCa) >= 0 &&
                                                                string.Compare(dateCheck, x.KetThuc_TheoCa) <= 0 &&
                                                            ...
                                                            {
                                                                if (timeOT > 8) timeOT = 8;
                                                            }
                                                            else
                                                            {
                                                                if (timeOT > 4)
                                                                    timeOT = timeOT >= 9.5 ? timeOT - 1.5 : (timeOT >= 9 ? 8 : (timeOT >= 5 ? timeOT - 1 : 4)); // 1 h nghỉ trưa
                                                            }
                                                            ...
                                                            ChamCongDB _congDB = item.lstChamCongDB.OrderByDescending(x => x.DateModified).FirstOrDefault(x => string.Compare(dateCheck, x.NgayBatDau) >= 0 && string.Compare(dateCheck, x.NgayKetThuc) <= 0 && (x.KyHieuChamCong == "EL" || x.KyHieuChamCong == "LC"));
                                                            if (_congDB != null && _congDB.GiaTri > 0)
                                                            {
                                                                timeOT -= _congDB.GiaTri;
                                                            }
                                                        ...
                                                        else if (CheckNgayDB(dateCheck, CommonConstants.CA_NGAY, true) == 2) // ngay truoc le
                                                        {
                                                            var clviec = item.lstNhanVienCaLamViec.FirstOrDefault(x =>
                                                             string.Compare(dateCheck, x.BatDau_TheoCa) >= 0 &&
                                                             string.Compare(dateCheck, x.KetThuc_TheoCa) <= 0 &&
                                                            ...
                                                            string newBeginOT = GetTimeCaLamViec(item.BoPhan, _caLamViec.MaCaLaviec, dateCheck, item.VP_SX).BeginTimeOT;//"17:30:00";
                                                        ...
                                                        if (HR_NHANVIEN_CHEDO_DBs.Exists(x => x.MaNhanVien == item.MaNV && x.CheDoDB.Contains("vp_Block_10p")) && string.Compare(dateCheck, "2022-10-24") >= 0)
                                                        {
                                                            ...
                                                            {
                                                                if (DateTime.ParseExact(lastTime, "HH:mm:ss", CultureInfo.InvariantCulture) >= DateTime.ParseExact("13:15:00", "HH:mm:ss", CultureInfo.InvariantCulture) ||
                                                                (GetTimeCaLamViec(item.BoPhan, CommonConstants.CA_NGAY, dateCheck, item.VP_SX).EndWorking == "17:00:00"))
                                                                {
                                                                    ELLC += 0;
                                                                }
                                                                else
                                                            ...
                                                            else if ((new int[] { 1, 3, 4 }).Contains(CheckNgayDB(dateCheck, CommonConstants.CA_NGAY, false)))
                                                            {
                                                                ELLC = 0;
                                                            }
                                                        }
                                                        else
                                                        {
                                                            if (BreakHaftDay(kyhieuChamCongDB.NullString()))
                                                            {
                                                                if ((DateTime.ParseExact(lastTime, "HH:mm:ss", CultureInfo.InvariantCulture) - DateTime.ParseExact(firstTime, "HH:mm:ss", CultureInfo.InvariantCulture)).TotalHours > 4)
                                                                {
                                                                    ELLC = 0;
                                                                }
                                                            }
                                                        ...
                                                        if (congDB != null && !(new int[] { 1, 3 }).Contains(CheckNgayDB(dateCheck, CommonConstants.CA_NGAY, false)) && congDB.GiaTri > 0)
                                                        {
                                                            ELLC = congDB.GiaTri;
                                                        }
                                                    ...
                                                    {
                                                        if (dateCheck == "2024-02-08" && item.lstNhanVienCaLamViec.Any(x => string.Compare(x.BatDau_TheoCa, dateCheck) <= 0 && string.Compare(x.KetThuc_TheoCa, dateCheck) >= 0)) //&& x.CaLV_DB != "HC"
                                                        {
                                                            ...
                                                            if (DateTime.ParseExact(lastTime, "HH:mm:ss", CultureInfo.InvariantCulture) > DateTime.ParseExact("22:00:00", "HH:mm:ss", CultureInfo.InvariantCulture))
                                                            {
                                                                lastTime = "22:00:00";
                                                            }
                                                        }
                                                        ...
                                                        {
                                                            if (DateTime.ParseExact(firstTime, "HH:mm:ss", CultureInfo.InvariantCulture) <= DateTime.ParseExact("20:10:00", "HH:mm:ss", CultureInfo.InvariantCulture))
                                                            {
                                                                firstTime = "20:00:00";
                                                            }
                                                        ...
                                                        if (CheckNgayDB(dateCheck, CommonConstants.CA_DEM, true) == 0) // ngay thuong
                                                        {
                                                            ...
                                                            string newBeginOT = GetTimeCaLamViec(item.BoPhan, _caLamViec.MaCaLaviec, dateCheck, item.VP_SX).BeginTimeOT;//"05:00:00";
                                                            ...
                                                            if (string.Compare(lastTime, newBeginOT) > 0)
                                                            {
                                                                item.OvertimeValues.AddRange(GetOvertimeInNight(firstTime, lastTime, dateCheck, "NT", isRegistedOT, item.MaNV, ref denghiOTModel));

                                                                if (newBeginOT == "04:00:00")
                                                                {
                                                                    double timeOT = 0;
                                                                    if (string.Compare(lastTime, "05:00:00") >= 0)
                                                                    {
                                                                        timeOT = 1;
                                                                    }
                                                                    else
                                                                    {
                                                                        timeOT = (DateTime.ParseExact(dateCheck + " " + lastTime, "yyyy-MM-dd HH:mm:ss", CultureInfo.InvariantCulture) - DateTime.ParseExact(dateCheck + " " + newBeginOT, "yyyy-MM-dd HH:mm:ss", CultureInfo.InvariantCulture)).TotalHours;
                                                                    }
                                                                    ...
                                                                    denghiOTModel.From = newBeginOT;
                                                                    denghiOTModel.To = lastTime;
                                                                    denghiOTModel.Duration = (double.Parse(denghiOTModel.Duration) + double.Parse(timeOT.IfNullIsZero())).ToString();
                                                                }
                                                            }
                                                        ...
                                                        else if (CheckNgayDB(dateCheck, CommonConstants.CA_DEM, true) == 5 || CheckNgayDB(dateCheck, CommonConstants.CA_DEM, true) == 7) // Ngay ki niem cty
                                                        {
                                                        ...
                                                        else if (CheckNgayDB(dateCheck, CommonConstants.CA_DEM, true) == 3 || CheckNgayDB(dateCheck, CommonConstants.CA_DEM, true) == 4) // ngay chu nhat + ngay nghi bu
                                                        {
                                                        ...
                                                        else if (CheckNgayDB(dateCheck, CommonConstants.CA_DEM, true) == 1) // ngay le
                                                        {
                                                        ...
                                                        else if (CheckNgayDB(dateCheck, CommonConstants.CA_DEM, true) == 2) // ngay truoc le
                                                        {
                                                            string kytu = "PH";
                                                            if (IsNgayDacBiet(dateCheck) != "")
                                                            {
                                                                kytu = "PM";
                                                            }
                                                            ...
                                                            {
                                                                DayCheck = dateCheck,
                                                                Value = kyhieuChamCongDB.NullString() == "" ? kytu : kyhieuChamCongDB.NullString(), // PH: làm ca đêm trước ngày lễ( thử việc)
                                                                FromTime = firstTime,
                                                                ToTime = lastTime
                                                            });
                                                        }
                                                        else if (CheckNgayDB(dateCheck, CommonConstants.CA_DEM, true) == 6) // ngay truoc le + chủ nhật
                                                        {
                                                            item.OvertimeValues.AddRange(GetOvertimeInNight(firstTime, lastTime, dateCheck, "TNL_CN", isRegistedOT, item.MaNV, ref denghiOTModel));
                                                            item.WorkingStatuses.Add(new WorkingStatus()
                                                            {
                                                                DayCheck = dateCheck,
                                                                Value = kyhieuChamCongDB.NullString() == "" ? "TVD" : kyhieuChamCongDB.NullString(),
                                                                FromTime = firstTime,
                                                                ToTime = lastTime
                                                            });
                                                        }
                                                        ...
                                                        if (HR_NHANVIEN_CHEDO_DBs.Exists(x => x.MaNhanVien == item.MaNV && x.CheDoDB.Contains("vp_Block_10p")) && string.Compare(dateCheck, "2022-10-24") >= 0)
                                                        {
                                                            ...
                                                            {
                                                                if (DateTime.ParseExact(lastTime, "HH:mm:ss", CultureInfo.InvariantCulture) >= DateTime.ParseExact("13:15:00", "HH:mm:ss", CultureInfo.InvariantCulture) ||
                                                                 GetTimeCaLamViec(item.BoPhan, _caLamViec.MaCaLaviec, dateCheck, item.VP_SX).EndWorking == "17:00:00")
                                                                {
                                                                    ELLC += 0;
                                                                }
                                                                else
                                                            ...
                                                            else if ((new int[] { 1, 3, 4 }).Contains(CheckNgayDB(dateCheck, _caLamViec.MaCaLaviec, false)))
                                                            {
                                                                ELLC = 0;
                                                            }
                                                        }
                                                        ...
                                                        ChamCongDB congDB = item.lstChamCongDB.OrderByDescending(x => x.DateModified).FirstOrDefault(x => string.Compare(dateCheck, x.NgayBatDau) >= 0 && string.Compare(dateCheck, x.NgayKetThuc) <= 0 && (x.KyHieuChamCong == "EL" || x.KyHieuChamCong == "LC"));
                                                        if (congDB != null && !(new int[] { 1, 3 }).Contains(CheckNgayDB(dateCheck, CommonConstants.CA_DEM, false)) && congDB.GiaTri > 0)
                                                        {
                                                            ELLC = congDB.GiaTri;
                                                        }
                                                ...
                                                {
                                                    int checkDate = CheckNgayDB(dateCheck, _caLamViec.MaCaLaviec, false);

                                                    if (checkDate == 1 || checkDate == 5 || checkDate == 7)
                                                    {
                                                        item.WorkingStatuses.Add(new WorkingStatus()
                                                        {
                                                            DayCheck = dateCheck,
                                                    ...
                                                    double ELLC = 0;
                                                    ChamCongDB congDB = item.lstChamCongDB.OrderByDescending(x => x.DateModified).FirstOrDefault(x => string.Compare(dateCheck, x.NgayBatDau) >= 0 && string.Compare(dateCheck, x.NgayKetThuc) <= 0 && (x.KyHieuChamCong == "EL" || x.KyHieuChamCong == "LC"));
                                                    if (congDB != null && !(new int[] { 1, 3 }).Contains(CheckNgayDB(dateCheck, _caLamViec.MaCaLaviec, false)) && congDB.GiaTri > 0)
                                                    {
                                                        ELLC = congDB.GiaTri;
                                                    }
                                        ...
                                        {
                                            // check ca lam viec
                                            _caLamViec = item.lstNhanVienCaLamViec.OrderByDescending(x => x.BatDau_TheoCa).FirstOrDefault(x => string.Compare(dateCheck, x.BatDau_TheoCa) >= 0 && string.Compare(dateCheck, x.KetThuc_TheoCa) <= 0);
                                            ...
                                            if (_caLamViec != null)
                                            {
                                                ...
                                                if (_caLamViec.MaCaLaviec == CommonConstants.CA_DEM && firstTime != "00:00:00")
                                                {
                                                    ...
                                                    if (dateCheck != "2024-02-08" && firstTime != "")
                                                    {
                                                       ...
                                                       DateTime.ParseExact(firstTime, "HH:mm:ss", CultureInfo.InvariantCulture) <= DateTime.ParseExact("05:00:00", "HH:mm:ss", CultureInfo.InvariantCulture))
                                                        ...
                                                        else if (DateTime.ParseExact(firstTime, "HH:mm:ss", CultureInfo.InvariantCulture) <= DateTime.ParseExact("20:10:00", "HH:mm:ss", CultureInfo.InvariantCulture))
                                                        {
                                                            firstTime = "20:00:00";
                                                        }
                                                    }
                                                ...
                                                if (firstTime != "" && lastTime != "" && _chamCongLog.FirstIn.NullString() == CommonConstants.IN && _chamCongLog.LastOut.NullString() == CommonConstants.OUT && Math.Abs(TimeSpan.Parse(lastTime).Subtract(TimeSpan.Parse(firstTime)).TotalHours) >= 0.2)
                                                {
                                                    ...
                                                    if (_caLamViec.MaCaLaviec == CommonConstants.CA_NGAY)
                                                    {
                                                        ...
                                                        if (CheckNgayDB(dateCheck, CommonConstants.CA_NGAY, true) == 0) // ngay thuong
                                                        {
                                                            ...
                                                            if ((item.BoPhan == CommonConstants.SUPPORT_DEPT || HR_NHANVIEN_CHEDO_DBs.Exists(x => x.MaNhanVien == item.MaNV && x.CheDoDB.Contains("vp_Block_10p"))) && DateTime.Parse(dateCheck).DayOfWeek == DayOfWeek.Saturday &&
                                                               !CommonConstants.arrSatuday_VP_AbNormal.Contains(dateCheck))
                                                            {
                                                                //#region nghi t7 hoac t7 là ngay thuong k tinh OT
                                                                if (!CommonConstants.arrSatudayAbNormal.Contains(dateCheck))
                                                                {
                                                                    newBeginOT = "13:15:00";
                                                        ...
                                                        if (HR_NHANVIEN_CHEDO_DBs.Exists(x => x.MaNhanVien == item.MaNV && x.CheDoDB.Contains("vp_Block_10p")) && string.Compare(dateCheck, "2022-10-24") >= 0)
                                                        {
                                                            ...
                                                            {
                                                                if (DateTime.ParseExact(lastTime, "HH:mm:ss", CultureInfo.InvariantCulture) >= DateTime.ParseExact("13:15:00", "HH:mm:ss", CultureInfo.InvariantCulture) ||
                                                                GetTimeCaLamViec(item.BoPhan, CommonConstants.CA_NGAY, dateCheck, item.VP_SX).EndWorking == "17:00:00" || dateCheck == "2023-06-03")
                                                                {
                                                                    ELLC += 0;
                                                                }
                                                                else
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        if (CheckNgayDB(dateCheck, CommonConstants.CA_DEM, false) == 0) // ngay thuong
                                                        {
                                                            string newBeginOT = GetTimeCaLamViec(item.BoPhan, _caLamViec.MaCaLaviec, dateCheck, item.VP_SX).BeginTimeOT;//"05:00:00";
                                                        ...
                                                        else if (CheckNgayDB(dateCheck, CommonConstants.CA_DEM, true) == 2) // ngay truoc le
                                                        {
                                                            ...
                                                            {
                                                                DayCheck = dateCheck,
                                                                Value = kyhieuChamCongDB.NullString() == "" ? kytu : kyhieuChamCongDB.NullString(), // BH: làm ca đêm trước ngày lễ( chính thức)
                                                                FromTime = firstTime,
                                                                ToTime = lastTime
                                                            });
                                                        }
                                                        else if (CheckNgayDB(dateCheck, CommonConstants.CA_DEM, true) == 6) // ngay truoc le + cn
                                                        {
                                                            item.OvertimeValues.AddRange(GetOvertimeInNight(firstTime, lastTime, dateCheck, "TNL_CN", isRegistedOT, item.MaNV, ref denghiOTModel));
                                                            item.WorkingStatuses.Add(new WorkingStatus()
                                                            {
                                                                DayCheck = dateCheck,
                                                                Value = kyhieuChamCongDB.NullString() == "" ? "D" : kyhieuChamCongDB.NullString(), // BH: làm ca đêm trước ngày lễ( chính thức)
                                                                FromTime = firstTime,
                                                                ToTime = lastTime
                                                            });
                                                        }
                                                        ...
                                                        if (DateTime.ParseExact(firstTime, "HH:mm:ss", CultureInfo.InvariantCulture) >= DateTime.ParseExact("00:00:00", "HH:mm:ss", CultureInfo.InvariantCulture) &&
                                                            DateTime.ParseExact(firstTime, "HH:mm:ss", CultureInfo.InvariantCulture) <= DateTime.ParseExact("05:00:00", "HH:mm:ss", CultureInfo.InvariantCulture))
                                                        {
                                                            ELLC += 4 + (DateTime.ParseExact(firstTime, "HH:mm:ss", CultureInfo.InvariantCulture) - DateTime.ParseExact("00:00:00", "HH:mm:ss", CultureInfo.InvariantCulture)).TotalHours;
                                                        }
                                                        ...
                                                        if (HR_NHANVIEN_CHEDO_DBs.Exists(x => x.MaNhanVien == item.MaNV && x.CheDoDB.Contains("vp_Block_10p")) && string.Compare(dateCheck, "2022-10-24") >= 0)
                                                        {
                                                            ...
                                                            {
                                                                if (DateTime.ParseExact(lastTime, "HH:mm:ss", CultureInfo.InvariantCulture) >= DateTime.ParseExact("13:15:00", "HH:mm:ss", CultureInfo.InvariantCulture) ||
                                                                GetTimeCaLamViec(item.BoPhan, CommonConstants.CA_DEM, dateCheck, item.VP_SX).EndWorking == "17:00:00")
                                                                {
                                                                    ELLC += 0;
                                                                }
                                                                else
                                                            ...
                                                            else if ((new int[] { 1, 3, 4 }).Contains(CheckNgayDB(dateCheck, CommonConstants.CA_DEM, false)))
                                                            {
                                                                ELLC = 0;
                                                            }
                                                        }
                                                        ...
                                                        {
                                                            if ((new int[] { 1, 3, 4 }).Contains(CheckNgayDB(dateCheck, CommonConstants.CA_DEM, false)))
                                                            {
                                                                ELLC = 0;
                                                            }
                                                        }
                                                ...
                                                {
                                                    int checkDate = CheckNgayDB(dateCheck, _caLamViec.MaCaLaviec, false);
                                                    if (checkDate == 1 || checkDate == 4 || checkDate == 5 || checkDate == 7) // ngay le
                                                    {
                                                        if (checkDate == 1)
                                                        {
                                                            item.WorkingStatuses.Add(new WorkingStatus()
                                                        ...
                                                        else if (checkDate == 5 || checkDate == 7) // Ngày kỉ niệm công ty
                                                        {
                                                            item.WorkingStatuses.Add(new WorkingStatus()
                                                            {
                                                                DayCheck = dateCheck,
                                                    ...
                                                    if (HR_NHANVIEN_CHEDO_DBs.Exists(x => x.MaNhanVien == item.MaNV && x.CheDoDB.Contains("vp_Block_10p")) && string.Compare(dateCheck, "2022-10-24") >= 0)
                                                    {
                                                        if (BreakHaftDay(kyhieuChamCongDB.NullString()))
                                                        {
                                                            if (GetTimeCaLamViec(item.BoPhan, _caLamViec.MaCaLaviec, dateCheck, item.VP_SX).EndWorking == "17:00:00" || dateCheck == "2023-06-03")
                                                            {
                                                                el += 0;
                                                            }
                                                            else
                                                ...
                                                else if (_chamCongLog.FirstIn.NullString() == "" && _chamCongLog.LastOut.NullString() != "")
                                                {
                                                    ...
                                                    if (checkDate == 1 || checkDate == 4 || checkDate == 5 || checkDate == 7) // ngay le
                                                    {
                                                        ...
                                                        else if (checkDate == 5 || checkDate == 7)
                                                        {
                                                            item.WorkingStatuses.Add(new WorkingStatus()
                                                            {
                                                                DayCheck = dateCheck,
        ...
        private List<OvertimeValue> GetOvertimeInNight(string firstTime, string lastTime, string dateCheck, string ngayLviec, bool isRegistedOT, string maNV, ref DeNghiLamThemGioModel themGioModel)
        {
            ...
            if (DateTime.ParseExact(firstTime, "HH:mm:ss", CultureInfo.InvariantCulture) >= DateTime.ParseExact("20:00:00", "HH:mm:ss", CultureInfo.InvariantCulture) ||
                DateTime.ParseExact(firstTime, "HH:mm:ss", CultureInfo.InvariantCulture) <= DateTime.ParseExact("05:00:00", "HH:mm:ss", CultureInfo.InvariantCulture) || dateCheck == "2024-02-08")
            {
                if (ngayLviec == "NT")
                {
                ...
                else if (ngayLviec == "NL")
                {
                    ...
                    if (dateCheck == "2024-02-08")
                    {
                        ...
                        {
                            timeOT1 = (DateTime.ParseExact(dateCheck + " " + lastTime, "yyyy-MM-dd HH:mm:ss", CultureInfo.InvariantCulture) - DateTime.ParseExact(dateCheck + " " + "15:00:00", "yyyy-MM-dd HH:mm:ss", CultureInfo.InvariantCulture)).TotalHours;
                        }
                        ...
                        if (DateTime.ParseExact(lastTime, "HH:mm:ss", CultureInfo.InvariantCulture) >= DateTime.ParseExact("17:00:00", "HH:mm:ss", CultureInfo.InvariantCulture))
                        {
                            timeOT2 = (DateTime.ParseExact(dateCheck + " " + lastTime, "yyyy-MM-dd HH:mm:ss", CultureInfo.InvariantCulture) - DateTime.ParseExact(dateCheck + " " + "17:00:00", "yyyy-MM-dd HH:mm:ss", CultureInfo.InvariantCulture)).TotalHours;

                            if (timeOT2 > 5) timeOT2 = 5;
                        }
                    ...
                    else
                    {
                        ...
                        // 00 -> 06h
                        double timeOT3 = GetOverTimeInRange("00:00:00", "06:00:00", firstTime, lastTime, dateCheck, false) - 1;
                        if (timeOT3 >= 4.5) timeOT3 = timeOT3 - 0.5;
                        if (timeOT3 > 0)
                        {
                            string hsOT = clviecs.FirstOrDefault(x => x.Time_BatDau == "22:00:00")?.HeSo_OT.IfNullIsZero();
                            lstResult.Add(new OvertimeValue()
                ...
                else if (ngayLviec == "NLCC" && IsChuNhat(dateCheck))
                {
                    var clviecs = CA_LVIECs.FindAll(x => x.DM_NgayLViec == ngayLviec && x.Danhmuc_CaLviec == CommonConstants.CA_DEM && x.HeSo_OT != 100);
                ...
                else if (ngayLviec == "TNL_CN") // TRƯƠC NGÀY LỄ LÀ NGÀY CN
                {
                    var clviecs = CA_LVIECs.FindAll(x => x.DM_NgayLViec == ngayLviec && x.Danhmuc_CaLviec == CommonConstants.CA_DEM && x.HeSo_OT != 100);
                    ...
                    if (timeOT2 > 0)
                    {
                        string hsOT = clviecs.FirstOrDefault(x => x.Time_KetThuc == "23:59:59")?.HeSo_OT.IfNullIsZero();
                        lstResult.Add(new OvertimeValue()
                        {
                            DayCheckOT = dateCheck,
                            DMOvertime = hsOT,
                    ...
                    // 00 -> 06
                    double timeOT3 = GetOverTimeInRange("00:00:00", "06:00:00", firstTime, lastTime, dateCheck, false) - 1.5;
                    if (timeOT3 > 0)
                    {
                        string hsOT = clviecs.FirstOrDefault(x => x.Time_KetThuc == "06:00:00")?.HeSo_OT.IfNullIsZero();
                        lstResult.Add(new OvertimeValue()
        ...
        public string IsNgayDacBiet(string time)
        {
        ...
        private int CheckNgayDB(string time, string calviec = "", bool isOT = true)
        {
            ...
            if (isOT)
            {
                ...
                {
                    if (IsNgayDacBiet(time) != "" && IsChuNhat(time))
                    {
                        return 7;
                    }
                ...
                else
                {
                    ...
                    if (IsNgayTruocLe(time) != "" && IsChuNhat(time))
                    {
                        return 6;
                    }
        ...
        /// <param name="calamviec">CN_WHC , CD_WHC</param>
        /// <returns></returns>
        private SETTING_TIME_CA_LVIEC GetTimeCaLamViec(string boPhan, string calamviec, string datecheck, string VPSX)
        {
            if (VPSX == "VP")
            {
                boPhan = "SP";
            ...
            List<SETTING_TIME_CA_LVIEC> lst = new List<SETTING_TIME_CA_LVIEC>();
            lst = SETTING_TIME_CA_LVIECs.FindAll(x => x.CaLamViec == calamviec && (x.BoPhan == boPhan || x.BoPhan == "ALL") && x.NgayBatDau.CompareTo(datecheck) <= 0 && x.NgayKetThuc.CompareTo(datecheck) >= 0).OrderBy(x => x.NgayBatDau).ToList();
        ...
        public double Block30mValueOT(double value)
        {
            ...
            double newVal = pthaphan;
            if (blockTime.ContainsKey((int)(minute * 10)))
            {
                newVal = blockTime[(int)(minute * 10)];
            }
