...
{
    public class EhsKeHoachDaoTaoATLDViewModel
    {
        public EhsKeHoachDaoTaoATLDViewModel()
        {
            EHS_THOIGIAN_THUC_HIEN_DAOTAO_ATVSLD = new HashSet<EhsThoiGianThucHienDaoTaoATVSViewModel>();
        }
        ...
        public double CostTotal { get => 
                CostMonth_1 + CostMonth_2 + CostMonth_3 + CostMonth_4
                + CostMonth_5 + CostMonth_6 + CostMonth_7 + CostMonth_8 
                + CostMonth_9 + CostMonth_10 + CostMonth_11 + CostMonth_12;
        }
        ...
        public ICollection<EhsThoiGianThucHienDaoTaoATVSViewModel> EHS_THOIGIAN_THUC_HIEN_DAOTAO_ATVSLD { get; set; }
    }
}
