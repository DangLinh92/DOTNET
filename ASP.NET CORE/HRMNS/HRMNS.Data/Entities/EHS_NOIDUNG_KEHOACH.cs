...
namespace HRMNS.Data.Entities
{
    ...
    //        string ngaythuchien, string thoigianthuchien, string vitri, double soluong, string ngaykhaibaoTB, string thoigianthongbao, string mahieuKtra, string ketqua, string status, double tiendo,string nguoiPhuTrach)
    //    {
    //        Id = id;
    //        Year = year;
    //        MaNoiDung = maNoiDung;
