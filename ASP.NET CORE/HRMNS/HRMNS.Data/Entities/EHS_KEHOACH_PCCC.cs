...
namespace HRMNS.Data.Entities
{
    ...
    public class EHS_KEHOACH_PCCC : DomainEntity<Guid>, IDateTracking
    {
        public EHS_KEHOACH_PCCC()
        {
        ...
        public virtual ICollection<EHS_THOIGIAN_THUC_HIEN_PCCC> EHS_THOIGIAN_THUC_HIEN_PCCC { get; set; }
    }
}
