...
namespace VOC.Areas.Admin.Controllers
{
    public class AccountController : AdminBaseController
    {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new APP_USER { UserName = model.Username, FullName = model.FullName, Email = model.Email, ShowPass = model.Password, Avatar = "/img/user.jpg", DateCreated = DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") };
